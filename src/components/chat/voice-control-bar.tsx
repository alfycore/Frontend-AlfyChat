  ...
  return (
    <div className="border-t border-[var(--border)]/30 bg-[var(--surface)]/60 px-3 py-2.5 backdrop-blur-xl">
      ...
      <div className="mb-2 flex items-center gap-2">
        <div className={cn(
          'flex size-5 shrink-0 items-center justify-center rounded-xl',
        ...
        <span className="ml-auto rounded-xl bg-[var(--surface-secondary)]/40 px-2 py-0.5 text-[10px] font-medium text-[var(--muted)]">
