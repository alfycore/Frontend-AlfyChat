...
export function useUIStyle() {
  ...
  return {
    ...
    // ── Input bar ─────────────────────────────────────────────────────────
    inputBar: g
      ? 'rounded-2xl border border-white/15 bg-white/60 dark:border-white/10 dark:bg-white/8'
      : 'rounded-xl border border-[var(--border)] bg-[var(--surface)]',

    // ── Reply bar (above input) ────────────────────────────────────────────
    replyBar: g
      ? 'rounded-t-2xl border border-b-0 border-white/15 bg-white/30 dark:border-white/10 dark:bg-white/5'
      : 'rounded-t-xl border border-b-0 border-[var(--border)] bg-[var(--surface-secondary)]',

    // ── Clickable rows (DM entries, friend entries) ────────────────────────
    row: g
      ? 'rounded-2xl border border-white/15 bg-white/30 hover:bg-white/40 dark:border-white/10 dark:bg-white/5 dark:hover:bg-white/8'
      : 'rounded-xl hover:bg-[var(--surface-secondary)]/70',

    // ── Empty-state / info cards ───────────────────────────────────────────
    emptyCard: g
      ? 'rounded-3xl border border-white/20 bg-white/30 dark:border-white/10 dark:bg-white/5'
      : 'rounded-2xl border border-[var(--border)] bg-[var(--surface-secondary)]',

    // ── Date separator chip ────────────────────────────────────────────────
    chip: g
      ? 'rounded-2xl border border-white/15 bg-white/30 dark:border-white/10 dark:bg-white/8'
      : 'rounded-full border border-[var(--border)] bg-[var(--surface)]',

    // ── Announcement / info banner ─────────────────────────────────────────
    announcementBanner: g
      ? 'rounded-2xl border border-amber-500/25 bg-amber-500/10 dark:border-amber-500/20 dark:bg-amber-500/8'
