    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center text-center p-4">
        <div>
          ...
          <p className="text-muted-foreground text-sm mb-4">VÃ©rifiez le lien ou retournez au marketplace.</p>
          <Link href="/hosting">
      ...
      <div className="max-w-2xl mx-auto px-4 py-10 space-y-6">
        ...
        <div className="text-center">
          ...
          <p className="text-muted-foreground text-sm">
            Aucune commission AlfyChat â€” paiement direct Ã  l'hÃ©bergeur.
          </p>
        </div>
        ...
        <p className="text-center text-xs text-muted-foreground">
          En validant, vous acceptez les CGU hÃ©bergeur. Paiement sÃ©curisÃ© â€” AlfyChat ne stocke aucune donnÃ©e bancaire.
        </p>
      </div>
    </div>
  );
