...
export default function HostingMarketplacePage() {
  ...
  return (
    <div className="bg-background text-foreground">
      {/* Hero */}
      <div className="bg-gradient-to-br from-indigo-950 via-background to-background border-b border-white/10 py-12 px-6 text-center">
        <Badge className="mb-4 bg-indigo-600/30 text-indigo-300 border-indigo-600/40">Hébergement Partenaire</Badge>
        <h1 className="text-3xl font-bold font-heading mb-3">Choisissez votre hébergement</h1>
        ...
        <div className="flex items-center justify-center gap-3 mt-6">
          <Link href="/channels/hosting/panel">
            <Button variant="outline" size="sm">
              <i className="bi bi-server mr-2" />
              Mon panel hébergeur
            </Button>
          </Link>
          <Link href="/channels/hosting/panel/register">
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        {/* CTA hébergeur */}
        <div className="mt-12 rounded-2xl bg-gradient-to-r from-indigo-950/60 to-purple-950/60 border border-indigo-800/40 p-8 text-center">
          ...
          <div className="flex items-center justify-center gap-3 flex-wrap">
            ...
            <Link href="/channels/hosting/panel">
              <Button variant="outline">
                <i className="bi bi-layout-sidebar mr-2" />
                Accéder au panel
              </Button>
            </Link>
          </div>
  ...
  return (
    <Card className="bg-white/5 border-white/10 hover:border-white/20 transition-all hover:-translate-y-0.5 flex flex-col">
      ...
      <CardContent className="flex-1 flex flex-col gap-3">
        ...
        <Link href={`/channels/hosting/checkout?offer=${offer.id}`} className="mt-2">
